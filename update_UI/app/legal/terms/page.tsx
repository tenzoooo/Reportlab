        ...
        <div className="min-h-screen bg-background py-20">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none">
                    ...
                    <h2>第5条（データの権利帰属）</h2>
                    <p>ユーザーが本サービスに入力した実験データ、テキスト、および本サービスを利用して生成されたレポート等の著作権は、ユーザーご本人に帰属します。当社がこれらのデータをユーザーの許可なく無断で利用したり、権利を主張したりすることはありません。</p>
                    ...
                    <ul>
                        ...
                        <li>当社，ほかのユーザー，またはその他第三者のサーバーまたはネットワークの機能を破壊したり，妨害したりする行為（DoS攻撃等を含みます。）</li>
                        <li>本サービスのシステム等に過度な負荷をかける行為</li>
                        <li>本サービスのリバースエンジニアリング、逆コンパイル、または逆アセンブル等の行為</li>
                        <li>本サービスに含まれるデータをスクレイピング等により不正に収集する行為</li>
                        <li>1人で複数のアカウントを作成する行為（フリートライアルの悪用防止等を含む）</li>
                    ...
                    <p>ユーザーが前項のいずれかに該当した場合、当社は事前の通知なく、当該ユーザーのアカウントを停止または削除することができるものとします。</p>

                    <h2>第7条（本サービスの提供の停止等）</h2>
                    <ol>
                        <li>当社は，以下のいずれかの事由があると判断した場合，ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止，中断，または終了することができるものとします。
                            <ul>
                        ...
                        <li>当社は，本サービスの提供の停止，中断，または終了により，ユーザーまたは第三者が被ったいかなる不利益または損害についても，一切の責任を負わないものとします。</li>
                    </ol>
                    ...
                    <ol>
                        <li>当社は，本サービスを現状有姿（あるがままの状態）で提供するものであり、本サービスに事実上または法律上の瑕疵（安全性，信頼性，正確性，完全性，有効性，特定の目的への適合性，セキュリティなどに関する欠陥，エラーやバグ，権利侵害などを含みます。）がないことを明示的にも黙示的にも保証しておりません。</li>
                        <li>本サービスはAI（人工知能）技術を利用しており、生成される情報の正確性、完全性、最新性についてはいかなる保証も行いません。AIが生成した情報に誤りが含まれる可能性があることをユーザーは予め承諾するものとします。</li>
                        <li>ユーザーが本サービスを利用して作成したレポート等を学校等の教育機関に提出した結果、不正行為とみなされたり、不利益な処分を受けたりした場合であっても、当社は一切関知せず、何らの責任も負わないものとします。</li>
                        ...
                        <li>前項ただし書に定める場合であっても，当社は，当社の過失（重過失を除きます。）による債務不履行または不法行為によりユーザーに生じた損害のうち特別な事情から生じた損害（当社またはユーザーが損害発生を予見し，または予見し得た場合を含みます。）について一切の責任を負いません。また，当社の過失（重過失を除きます。）による債務不履行または不法行為によりユーザーに生じた損害の賠償は，ユーザーから当該損害が発生した月に受領した利用料の額（無料ユーザーの場合は0円）を上限とします。</li>
                    ...
                    <ol>
                        ...
                        <li>本サービスに関して紛争が生じた場合には，横浜地方裁判所を第一審の専属的合意管轄裁判所とします。</li>
                    </ol>
